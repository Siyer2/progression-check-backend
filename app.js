...
app.post('/program/get', (request, response) => {
    try {
...
app.post('/program/autocomplete', (request, response) => {
    try {
...
app.post('/course/get', (request, response) => {
...
app.post('/course/autocomplete', (request, response) => {
    try {
        const query = request.body.query;
...
app.post('/program/requirements', (request, response) => {
    try {
        const code = request.body.code;
        const implementation_year = request.body.implementation_year;
